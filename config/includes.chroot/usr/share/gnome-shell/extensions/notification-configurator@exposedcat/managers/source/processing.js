export class ProcessingAdapter {
    ...
    createHook() {
        ...
        return (_addNotification, notification, { block }) => {
            ...
            const configuration = settingsManager.getConfigurationFor(sourceTitle, notificationTitle, notificationBody);
            ...
            const filterAction = settingsManager.getFilterFor(sourceTitle, notificationTitle, notificationBody);
