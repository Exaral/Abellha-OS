...
First open terminal and type cd /usr/share/icons/desktop-base/scalable/emblems. Now open another terminal window, or tab, and type to cd to the Icons and Logos folder and then Logos.
